...
🔗 [Open on LeetCode](https://leetcode.com/problems/check-if-there-is-a-valid-path-in-a-grid/) | **Medium** | `Array` `Depth-First Search` `Breadth-First Search` `Union-Find` `Matrix`
